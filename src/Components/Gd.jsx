          ...
          >
            <AccordionItem>
              ...
              <AccordionPanel pb={4} className=" flex flex-wrap">
                <a
                  ...
                  href="https://drive.google.com/file/d/1f1jSRg1m8O0hUtLhc6aa_6LD4QgKj2eL/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  Camera & Photography
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} className=" flex flex-wrap">
                <a
                  className="link-style"
                  href="https://drive.google.com/file/d/1v0NZYObNHeJD0L7iw7L9aharaq_-Ug2d/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  Photoshop Shortcuts
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} className=" flex flex-wrap">
                <a
                  className="link-style"
                  href="https://drive.google.com/file/d/1Ixlec2k_T4b7krdgtaS9ZhwHcEnG4p7j/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  Eod one short
