            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} className=" flex flex-wrap">
                <a
                  ...
                  href="https://drive.google.com/file/d/1VonNJC5Q_VuC8B0Is2qG0i7p15RGON7_/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  One short
                ...
                <a
                  className="link-style"
                  href="https://drive.google.com/file/d/1Iv90kuVRuAnoijCiAukJeQhKYEkMZzRW/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  Types
                ...
                <a
                  className="link-style"
                  href="https://drive.google.com/file/d/11Vsj3H_43X7_skVpDdzJvSSmA_d3OGSs/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  Classification
